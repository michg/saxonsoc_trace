...
class SmpBram(cpuCount : Int) extends Component{
...
object SmpBram {
  ...
  def default(g : SmpBram) = g.rework{
    import g._
  ...
  def main(args: Array[String]): Unit = {
    ...
    val report = SpinalRtlConfig
      .copy(
        ...
        inlineRom = true
      ).generateVerilog(InOutWrapper(default(new SmpBram(cpuCount))))
